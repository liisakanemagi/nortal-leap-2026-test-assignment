...
public class LibraryService {
    ...
    public Result deleteBook(String id) {
        ...
        Book book = existing.get();
        //      Suggestion:  if (book.getLoanedTo() != null) {
        //            return Result.failure("BOOK_ON_LOAN");
        //        }
    ...
    private static boolean bookIsReserved(String memberId, Book entity) {
        return !entity.getReservationQueue().isEmpty()
                && !entity.getReservationQueue().getFirst().equals(memberId);
    }
